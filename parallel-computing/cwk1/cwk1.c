//
// Starting code for coursework. Requires "cwk1_extra.h", which should be placed
...
//
// There is an optional command line argument for the number of cards to remove,
// 'numToRemove' (which defaults to zero). See coursework guidance for what
...
int main(int argc, char **argv) {
  ...
  // Optional command line argument; the number of cards to removed (defaults to
  // 0).
  ...
  //
  // Generate a full deck. You need to make pushCardToDeck() thread safe, and
